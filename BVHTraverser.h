...
//  this software.
//============================================================================
#ifndef vtk_m_rendering_pathtracing_BVH_Traverser_h
...
public:
  ...
  public:
                              ...
                              const LeafPortalType& leafs) const
    {
      ...
      if ((scattered & (1UL << ScatterBitIdx)) && (scattered & (1UL << HitBitIdx)))
        tmax = closestDistance;
    } // ()
  };
