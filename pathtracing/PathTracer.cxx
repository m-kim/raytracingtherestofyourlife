...
public:
  ...
  VTKM_CONT void run(vtkm::rendering::raytracing::Ray<Precision>& rays,
                     vtkm::cont::ArrayHandle<vtkm::Vec<vtkm::Float32, 4>>& colorMap,
                     const vtkm::rendering::pathtracing::Camera& camera,
                     bool shade)
  {
    if (shade)
    {
...
void PathTracer::AddShapeIntersector(vtkm::rendering::raytracing::ShapeIntersector* intersector)
{
  NumberOfShapes += intersector->GetNumberOfShapes();
  Intersectors.push_back(intersector);
}

void PathTracer::SetField(const vtkm::cont::Field& scalarField, const vtkm::Range& scalarRange)
{
  ScalarField = scalarField;
  ScalarRange = scalarRange;
}

void PathTracer::SetColorMap(const vtkm::cont::ArrayHandle<vtkm::Vec<vtkm::Float32, 4>>& colorMap)
{
  ColorMap = colorMap;
}

void PathTracer::Render(vtkm::rendering::raytracing::Ray<vtkm::Float32>& rays)
{
  RenderOnDevice(rays);
}

void PathTracer::Render(vtkm::rendering::raytracing::Ray<vtkm::Float64>& rays)
{
  RenderOnDevice(rays);
}

void PathTracer::SetShadingOn(bool on)
{
  Shade = on;
}

vtkm::Id PathTracer::GetNumberOfShapes() const
{
...
template <typename Precision>
void PathTracer::RenderOnDevice(vtkm::rendering::raytracing::Ray<Precision>& rays)
{
