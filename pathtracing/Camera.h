...
public:
  ...
  VTKM_CONT
  void CreateRays(vtkm::rendering::raytracing::Ray<vtkm::Float32>& rays, vtkm::Bounds bounds);

  VTKM_CONT
  void CreateRays(vtkm::rendering::raytracing::Ray<vtkm::Float64>& rays, vtkm::Bounds bounds);
  ...
  VTKM_CONT void CreateRaysImpl(vtkm::rendering::raytracing::Ray<Precision>& rays, const vtkm::Bounds boundingBox);

  void CreateDebugRay(vtkm::Vec<vtkm::Int32, 2> pixel, vtkm::rendering::raytracing::Ray<vtkm::Float32>& rays);

  void CreateDebugRay(vtkm::Vec<vtkm::Int32, 2> pixel, vtkm::rendering::raytracing::Ray<vtkm::Float64>& rays);

  bool operator==(const Camera& other) const;

private:
  template <typename Precision>
  void CreateDebugRayImp(vtkm::Vec<vtkm::Int32, 2> pixel, vtkm::rendering::raytracing::Ray<Precision>& rays);
  VTKM_CONT
  void FindSubset(const vtkm::Bounds& bounds);

  template <typename Precision>
  VTKM_CONT void UpdateDimensions(vtkm::rendering::raytracing::Ray<Precision>& rays,
