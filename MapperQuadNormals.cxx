...
struct MapperQuadNormals::InternalsType
{
  vtkm::rendering::CanvasRayTracer* Canvas;
  vtkm::rendering::raytracing::RayTracerNormals Tracer;
...
MapperQuadNormals::MapperQuadNormals()
...
void MapperQuadNormals::SetCanvas(vtkm::rendering::Canvas* canvas)
{
  if (canvas != nullptr)
  {
...
vtkm::rendering::Canvas* MapperQuadNormals::GetCanvas() const
{
  return this->Internals->Canvas;
}

void MapperQuadNormals::RenderCells(const vtkm::cont::DynamicCellSet& cellset,
...
void MapperQuadNormals::SetCompositeBackground(bool on)
{
  this->Internals->CompositeBackground = on;
}

void MapperQuadNormals::StartScene()
{
  // Nothing needs to be done.
}

void MapperQuadNormals::EndScene()
{
  // Nothing needs to be done.
}

vtkm::rendering::Mapper* MapperQuadNormals::NewCopy() const
{
  return new path::rendering::MapperQuadNormals(*this);
}
}
} // vtkm::rendering
